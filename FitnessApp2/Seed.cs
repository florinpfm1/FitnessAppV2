                            ...
                            CourseGuests = new List<CourseGuest>()
                            {
                                new CourseGuest()
                                {
                                    Guest = new Guest()
                                    {
                                        ...
                                        AddedDate = DateTime.Now,
                                        Hours = 2,
                                        Detail = new Detail() { Email = "anna@gmail.com", Phone = "0722888777" },
                                        Section = new Section() { Name = "Elev" }
                                    }
                                },
                                new CourseGuest()
                                {
                            ...
                            CourseGuests = new List<CourseGuest>()
                            {
                                ...
                                new CourseGuest()
                                {
                                    Guest = new Guest()
                                    {
                                        ...
                                        AddedDate = DateTime.Now,
                                        Hours = 2,
                                        Detail = new Detail() { Email = "vala@gmail.com", Phone = "0712111222" },
                            ...
                            CourseGuests = new List<CourseGuest>()
                            {
                                ...
                                new CourseGuest()
                                {
                                    Guest = new Guest()
                                    {
                                        ...
                                        AddedDate = DateTime.Now,
                                        Hours = 3,
                                        Detail = new Detail() { Email = "burt@gmail.com", Phone = "0769444222" },
                                        Section = new Section() { Name = "Employee" }
                                    }
                                }
                            }
